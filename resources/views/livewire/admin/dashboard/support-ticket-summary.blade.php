                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <p class="text-muted mb-0">
                                <span
                                    class="{{ $this->getNewTicketPercentageChange() < 0 ? 'text-success' : 'text-danger' }} fw-bold font-size-12 me-2">
                                    <i
                                        class="{{ $this->getNewTicketPercentageChange() < 0 ? 'ri-arrow-right-down-line' : 'ri-arrow-right-up-line' }} me-1 align-middle"></i>
                                    {{ number_format($this->getNewTicketPercentageChange(), 1) }}%
                                    <!-- removed abs() here -->
                                </span>
                                from previous month
                            </p>
