                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="assigned_to" class="form-control" id="assigned_to">
                                        ...
                                        @if ($task->assignee)
                                            <option value="{{ $task->assignee->id }}" selected>{{ $task->assignee->name }}
                                            </option>
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" class="form-control textEditor" required>{!! old('description', $task->description) !!}</textarea>
                                </div>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
