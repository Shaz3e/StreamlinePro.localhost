                ...
                <form action="{{ route('admin.todos.update', $todo->id) }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="card-body">
                                    ...
                                    <select name="todo_label_id" class="form-control select2" id="todo_label_id">
                                        @foreach ($todoLabels as $label)
                                            <option value="{{ $label->id }}"
                                                {{ $todo->todo_label_id == $label->id ? 'selected' : '' }}>
                                                {{ $label->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="todo_details"id="todo_details" class="form-control textEditor" required>{!! old('todo_details', $todo->todo_details) !!}</textarea>
                                </div>
                                @error('todo_details')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
