...
@include('partials.page-header', [
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.invoice-labels.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="text_color" class="form-control" id="colorpicker-text"
                                        value="{{ old('text_color', '#000000') }}" required>
                                    @error('text_color')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
