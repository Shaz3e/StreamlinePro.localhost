...
@section('content')
    ...
    {{-- Create Form --}}
    <form action="{{ route('admin.email-management.bulk-email-staff.update', $bulkEmailStaff) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-7 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subject" id="subject" class="form-control"
                                        value="{{ old('subject', $bulkEmailStaff->subject) }}" />
                                </div>
                                @error('subject')
                            ...
                            <div class="col-md-2 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="is_publish" class="form-control" id="is_publish">
                                        <option value="0" {{ old('is_publish', $bulkEmailStaff->is_publish) == 0 ? 'selected' : '' }}>Draft</option>
                                        <option value="1" {{ old('is_publish', $bulkEmailStaff->is_publish) == 1 ? 'selected' : '' }}>Publish</option>
                                    </select>
                                </div>
                                @error('is_publish')
                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" name="send_date" id="send_date"
                                        value="{{ old('send_date',$bulkEmailStaff->send_date) }}" min="{{ now()->format('Y-m-d\TH:i') }}">
                                </div>
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="content" class="form-control textEditor">{{ old('content', $bulkEmailStaff->content) }}</textarea>
                                </div>
                                @error('content')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
