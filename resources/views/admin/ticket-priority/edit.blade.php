                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="is_active" required>
                                    <option value="1"
                                        {{ old('is_active', $ticketPriority->is_active) == 1 ? 'selected' : '' }}>Show
                                    </option>
                                    <option value="0"
                                        {{ old('is_active', $ticketPriority->is_active) == 0 ? 'selected' : '' }}>Hide
                                    </option>
                                </select>
                                @error('is_active')
                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="text_color" class="form-control" id="colorpicker-text"
                                        value="{{ old('text_color', $ticketPriority->text_color) }}" required>
                                    @error('text_color')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bg_color" class="form-control" id="colorpicker-background"
                                        value="{{ old('bg_color', $ticketPriority->bg_color) }}" required>
                                    @error('bg_color')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
