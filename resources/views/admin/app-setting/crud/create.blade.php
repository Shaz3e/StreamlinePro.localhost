...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="alert alert-danger">
                <strong>Warning!</strong> Create this field may not cause error in the application create this if you know what
                you are doing.
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.app-settings.store') }}" method="POST" class="needs-validation" novalidate>
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
