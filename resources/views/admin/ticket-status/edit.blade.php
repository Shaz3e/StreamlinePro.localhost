        ...
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.ticket-status.update', $ticketStatus->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <label for="name" class="col-sm-2 col-form-label">Ticket Status Name</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="is_active" required>
                                    <option value="1"
                                        {{ old('is_active', $ticketStatus->is_active) == 1 ? 'selected' : '' }}>Show
                                    </option>
                                    <option value="0"
                                        {{ old('is_active', $ticketStatus->is_active) == 0 ? 'selected' : '' }}>Hide
                                    </option>
                                </select>
                                @error('is_active')
                                    <span class="text-danger">{{ $message }}</span>
