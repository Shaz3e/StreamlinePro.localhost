...
{{ $invoice->invoice_date ? $invoice->invoice_date->format('l, jS M Y') : $invoice->published_on->format('l, jS M Y') }} will be due in 3 days on {{ $invoice->due_date->format('l, jS M Y') }}.<br><br>
