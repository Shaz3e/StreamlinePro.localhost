...
class SupportTicketStatus extends Model implements Auditable
{
    ...
    /**
     * Relationship with Suport Tickets Table
     */
    public function tickets()
    {
        return $this->hasMany(SupportTicket::class, 'support_ticket_status_id');
    }
}
