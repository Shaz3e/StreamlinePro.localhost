...
class AppSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $appSettings = [
            ...
            ['name' => 'can_user_register', 'value' => 1],
            ['name' => 'can_user_reset_password', 'value' => 1],

            ['name' => 'login_page_heading', 'value' => null],
            ['name' => 'login_page_heading_color', 'value' => 'black'],
            ['name' => 'login_page_heading_bg_color', 'value' => 'white'],
            ['name' => 'login_page_text', 'value' => null],
            ['name' => 'login_page_text_color', 'value' => 'white'],
            ['name' => 'login_page_text_bg_color', 'value' => 'black'],
            ['name' => 'login_page_image', 'value' => 'settings/page/login-page.jpg'],

            ['name' => 'register_page_heading', 'value' => null],
            ['name' => 'register_page_heading_color', 'value' => 'black'],
            ['name' => 'register_page_heading_bg_color', 'value' => 'white'],
            ['name' => 'register_page_text', 'value' => null],
            ['name' => 'register_page_text_color', 'value' => 'white'],
            ['name' => 'register_page_text_bg_color', 'value' => 'black'],
            ['name' => 'register_page_image', 'value' => 'settings/page/register-page.jpg'],

            ['name' => 'reset_page_heading', 'value' => null],
            ['name' => 'reset_page_heading_color', 'value' => 'black'],
            ['name' => 'reset_page_heading_bg_color', 'value' => 'white'],
            ['name' => 'reset_page_text', 'value' => null],
            ['name' => 'reset_page_text_color', 'value' => 'white'],
            ['name' => 'reset_page_text_bg_color', 'value' => 'black'],
